...
public abstract class PotionBase extends Potion {
    ...
    public PotionBase(String name, boolean isBadEffect, int liquidColor) {
        ...
        this.texture = new ResourceLocation(PRRandomThings.MODID, "textures/effects/" + name + ".png");
        this.setRegistryName(PRRandomThings.MODID, name);
        this.setPotionName("effects." + PRRandomThings.MODID + "." + name);
    }
