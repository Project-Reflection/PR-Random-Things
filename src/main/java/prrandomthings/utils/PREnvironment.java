...
public class PREnvironment {
    ...
    public static void init(World world) {
        ...
        if (perlinNoise1x == null) {
            perlinNoise1x = new PerlinNoise.CauchyPerlinNoise(seed, 16.);
            perlinNoise3x = new PerlinNoise.CauchyPerlinNoise(seed, 16. / 3.);
            perlinNoise5x = new PerlinNoise.CauchyPerlinNoise(seed, 16. / 5.);
            perlinNoise7x = new PerlinNoise.CauchyPerlinNoise(seed, 16. / 7.);
        }
    }
